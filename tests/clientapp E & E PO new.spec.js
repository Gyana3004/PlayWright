...
customtest.only("Windows Handling for ",async({page,testDatafororder})=>
{
...
await loginpage.validLogin(testDatafororder.useraname,testDatafororder.password);  
...
expect (await page.locator(".user__name [type='text']").first()).toHaveText(testDatafororder.useraname);
